...
This project is indexed by GitNexus as **IN-OUT-tracker** (899 symbols, 1208 relationships, 9 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
